...
void CAN_TxCancel(uint8 bufferId) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgswitchStatus
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgswitchStatus(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_switchStatus_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_switchStatus_CALLBACK
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgADCdata
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgADCdata(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_ADCdata_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_ADCdata_CALLBACK
